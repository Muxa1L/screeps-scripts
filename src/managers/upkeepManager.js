...
const nukeService = require('./upkeep/nukeService');
const visualService = require('./upkeep/visualService');
...
function run() {
    ...
    assert.safeRun('nukeDetection', nukeService.tick);
    assert.safeRun('visuals', visualService.run);
}
